...
$(function(){FastClick.attach(document.body);var e=$("html"),n=$(window),a=$(".search-input"),i=$(".hamburger"),o=$(".search-text");if(window.matchMedia){var t=window.matchMedia("only screen and (-moz-min-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6/2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen  and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx)");t&&t.matches&&(document.documentElement.className+=" retina")}n.on("load",function(){e.addClass("loaded")}),o.on("focus",function(){a.addClass("search-focus")}),o.on("blur",function(){a.removeClass("search-focus")}),i.click(function(n){n.preventDefault(),e.toggleClass("js-nav-open")});var c=$(".featured-artists");c.flickity({cellAlign:"center",autoPlay:4e3,imagesLoaded:!0,wrapAround:!0,pageDots:!1,resize:!1,prevNextButtons:!0});var s=c.data("flickity");n.on("resize",function(){s&&s.resize()})});