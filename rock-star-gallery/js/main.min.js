...
$(function(){function e(){var e=$("footer").height();$(".wrapper").css("padding-bottom",e),$("footer").css("margin-top",-e)}FastClick.attach(document.body);var n=$("html"),a=$(window),o=$(".search-input"),i=$(".hamburger"),t=$(".search-text");if(window.matchMedia){var c=window.matchMedia("only screen and (-moz-min-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6/2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen  and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx)");c&&c.matches&&(document.documentElement.className+=" retina")}a.on("load",function(){n.addClass("loaded")}),t.on("focus",function(){o.addClass("search-focus")}),t.on("blur",function(){o.removeClass("search-focus")}),i.click(function(e){e.preventDefault(),n.toggleClass("js-nav-open")});var r=$(".featured-artists");r.flickity({cellAlign:"center",autoPlay:4e3,imagesLoaded:!0,wrapAround:!0,pageDots:!1,resize:!1,prevNextButtons:!0});var s=r.data("flickity");a.on("resize",function(){s&&s.resize()}),a.on("load resize",e)});